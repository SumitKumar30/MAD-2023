    ...
    return Scaffold(
      ...
      body: Container(
          decoration: const BoxDecoration (
            image: DecorationImage(image: AssetImage('images/batman.jpg'),
            fit: BoxFit.cover
            ),
      ), 
       ...
       child: Center(
        ...
        child: const Text('Unmask the Truth', style: TextStyle(fontSize: 28),),
      
       ),
      ),
      ),
      floatingActionButton: FloatingActionButton(
        onPressed: () {}, child: const Text('+', style: const TextStyle(fontSize: 30),),
       )
      );
  }
}